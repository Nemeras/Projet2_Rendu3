...
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : Form.form) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : Form.formlist) in
    Obj.repr(
# 30 "new_parser.mly"
...
# 172 "new_parser.ml"
               : Form.form))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : Form.form) in
    Obj.repr(
# 36 "new_parser.mly"
                          ( _2 )
# 179 "new_parser.ml"
               : Form.form))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : Form.form) in
    Obj.repr(
# 37 "new_parser.mly"
                          ( Not(fst _2,0),(snd _2) )
# 186 "new_parser.ml"
               : Form.form))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Form.form) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : Form.form) in
    Obj.repr(
# 38 "new_parser.mly"
...
let formula (lexfun : Lexing.lexbuf -> token) (lexbuf : Lexing.lexbuf) =
   (Parsing.yyparse yytables 1 lexfun lexbuf : Form.formlist)

...
open Parsing;;
let _ = parse_error;;
# 2 "Online/parser_cnf.mly"
open Cnf
# 12 "Online/parser_cnf.ml"
let yytransl_const = [|
  259 (* EOC *);
    0 (* EOF *);
    0|]

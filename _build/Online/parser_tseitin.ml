...
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : int Tseitin.form) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : int Tseitin.formlist) in
    Obj.repr(
# 26 "Online/parser_tseitin.mly"
                 ( (fst _1)::(fst _2), max (snd _1) (snd _2) )
# 156 "Online/parser_tseitin.ml"
               : int Tseitin.formlist))
; (fun __caml_parser_env ->
    Obj.repr(
# 27 "Online/parser_tseitin.mly"
         ( [], 0 )
# 162 "Online/parser_tseitin.ml"
               : int Tseitin.formlist))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : int) in
    Obj.repr(
# 31 "Online/parser_tseitin.mly"
         ( Lit (_1,0), _1 )
# 169 "Online/parser_tseitin.ml"
               : int Tseitin.form))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : int Tseitin.form) in
    Obj.repr(
# 32 "Online/parser_tseitin.mly"
                      ( _2 )
# 176 "Online/parser_tseitin.ml"
               : int Tseitin.form))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : int Tseitin.form) in
    Obj.repr(
# 33 "Online/parser_tseitin.mly"
             ( Not (fst _2,0), snd _2 )
# 183 "Online/parser_tseitin.ml"
               : int Tseitin.form))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : int Tseitin.form) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : int Tseitin.form) in
    Obj.repr(
# 34 "Online/parser_tseitin.mly"
                 ( Or (fst _1, fst _3, 0), max (snd _1) (snd _3) )
# 191 "Online/parser_tseitin.ml"
               : int Tseitin.form))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : int Tseitin.form) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : int Tseitin.form) in
    Obj.repr(
# 35 "Online/parser_tseitin.mly"
                  ( And (fst _1, fst _3, 0), max (snd _1) (snd _3) )
# 199 "Online/parser_tseitin.ml"
               : int Tseitin.form))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : int Tseitin.form) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : int Tseitin.form) in
    Obj.repr(
# 36 "Online/parser_tseitin.mly"
                   ( Or (Not (fst _1,0), fst _3, 0), max (snd _1) (snd _3) )
# 207 "Online/parser_tseitin.ml"
               : int Tseitin.form))
(* Entry formula *)
...
let formula (lexfun : Lexing.lexbuf -> token) (lexbuf : Lexing.lexbuf) =
   (Parsing.yyparse yytables 1 lexfun lexbuf : int Tseitin.formlist)

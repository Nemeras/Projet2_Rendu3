...
let choose_theory theory =
	...
	| _ -> failwith "Erreur dans le choix de la théorie"
		...
		(** MODULES PERMETTANT D'IMPLÉMENTER L'HEURISTIQUE VSIDS **)


module Lit =
struct
	type t = int*int	(* 1ère composante : le score du littéral en 2e composante *)
...
type parameters = {
	...
	vsids : bool ;			(* Indique si on doit utiliser l'heuristique VSIDS *)
